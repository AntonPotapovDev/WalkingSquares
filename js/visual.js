...
export class Meshes {
	...
	static defaultEnemyMesh()  { return makeMesh(50, 50, Colors.defaultEnemyColor, 2); }
	static fatEnemyMesh()  { return makeMesh(55, 55, Colors.fatEnemyColor, 2); }
